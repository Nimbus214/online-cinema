...
class UsersStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UserExist = channel.unary_unary(
                ...
                response_deserializer=users__pb2.ExistRequest.FromString,
...
def add_UsersServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'UserExist': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=users__pb2.ExistRequest.SerializeToString,
            ),
    }
...
class Users(object):
    ...
    def UserExist(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            users__pb2.ExistRequest.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
